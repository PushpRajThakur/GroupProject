<%-- 
    Document   : status
    Created on : 14 Apr, 2019, 3:24:57 PM
    Author     : HP
--%>
       ...
       <div class="header">
           ...
           <div class="navigation"><br><br>
               <nav>
                   ...
                   <a href="userdashboard.jsp">Profile</a>
                   <a href="help.html">Help &amp Support</a>
                   <button style="float: right;margin-right: 60px;font-family:monospace;background-color:white;color:black;text-shadow: 1px 1px black; border:none;font-size: 30px;margin-top: -20px;border-radius: 10px;">Anant1080</button>
               </nav>
           </div>
           
           <div class="middle">
            <p style="font-size: 25px;color:white;background-color: darkgoldenrod;text-align: center">Current Status</p>
              <center>
